...
df_recovery_local.to_csv(f'{num_trials}trials_{num_subjects}subjects_recovery_localparams1.csv', index=False)
...
df_recovery_criterion_heatmap.to_csv(f'{num_trials}trials_{num_subjects}subjects_recovery_criterion_heatmap1.csv', index=False)
...
df_posterior_means.to_csv(f'{num_trials}trials_{num_subjects}subjects_posterior_means1.csv', index=False)
...
file_name = '/vsc-hard-mounts/leuven-data/343/vsc34314/5000 trials/50subjects_5000trials1.dil'
list_of_variable_names = (
    "all_lps", "all_true_params", "all_true_states","all_inf_params", "all_inf_states",
    "all_emissions", "all_inputs",
    "all_posterior_samples_a", "all_posterior_samples_sigmasq", "all_posterior_samples_w", "all_posterior_samples_states","all_posterior_samples_states_sd",
    "all_posterior_samples_a0", "all_posterior_samples_nu_a0",
    "all_posterior_samples_alpha", "all_posterior_samples_beta",
    "all_posterior_samples_w_0","all_posterior_samples_nu_w0",
    "true_w0", "true_nu_w", "true_a", "true_nu_a", "true_alpha", "true_beta",
    "num_subjects","num_trials", "num_inputs","num_datasets"
    )
