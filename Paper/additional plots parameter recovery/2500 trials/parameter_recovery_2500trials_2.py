...
keys = jr.split(jr.PRNGKey(1235), num_datasets)
...
df_recovery_local.to_csv(f'{num_trials}trials_{num_subjects}subjects_recovery_localparams2.csv', index=False)
...
df_recovery_criterion_heatmap.to_csv(f'{num_trials}trials_{num_subjects}subjects_recovery_criterion_heatmap2.csv', index=False)
...
df_posterior_means.to_csv(f'{num_trials}trials_{num_subjects}subjects_posterior_means2.csv', index=False)



# Save environment to dil file
# Give other name such that dill file from other 2500trials recovery can be loaded in in the same environment
# without overwritting each other

all_lps2 = all_lps
all_true_params2 = all_true_params 
all_true_states2 = all_true_states

all_posterior_samples_states2 = all_posterior_samples_states
all_posterior_samples_states_sd2 = all_posterior_samples_states_sd

all_posterior_samples_a2 = all_posterior_samples_a
all_posterior_samples_sigmasq2 = all_posterior_samples_sigmasq
all_posterior_samples_w2 = all_posterior_samples_w
all_posterior_samples_mu_x2 = all_posterior_samples_mu_x


all_posterior_samples_mu_a2 = all_posterior_samples_mu_a
all_posterior_samples_sigma_a2 = all_posterior_samples_sigma_a
all_posterior_samples_beta_sigmasq2 = all_posterior_samples_beta_sigmasq
all_posterior_samples_sigma_mu_x2 = all_posterior_samples_sigma_mu_x
all_posterior_samples_mu_sigmasq2 = all_posterior_samples_mu_sigmasq
all_posterior_samples_mu_w2 = all_posterior_samples_mu_w
all_posterior_samples_sigma_w2 = all_posterior_samples_sigma_w




file_name = '/vsc-hard-mounts/leuven-data/343/vsc34314/hMFC/50subjects_2500trials2.dil'

list_of_variable_names = (
    "all_lps2", "all_true_params2", "all_true_states2",
    "all_posterior_samples_states2","all_posterior_samples_states_sd2",
    "all_posterior_samples_a2", "all_posterior_samples_sigmasq2", "all_posterior_samples_w2", "all_posterior_samples_mu_x2",
    "all_posterior_samples_mu_a2", "all_posterior_samples_sigma_a2",
    "all_posterior_samples_mu_sigmasq2", "all_posterior_samples_beta_sigmasq2",
    "all_posterior_samples_sigma_mu_x2",
    "all_posterior_samples_mu_w2","all_posterior_samples_sigma_w2",
