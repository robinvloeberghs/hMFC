...
seed = jnp.arange(num_datasets) + 25 # to make sure we don't have the same datasets as other file
...
all_inf_params2 = all_inf_params
all_inf_states2 = all_inf_states
all_emissions2 = all_emissions
all_inputs2 = all_inputs
all_lps2 = all_lps
all_posterior_samples_a02 = all_posterior_samples_a0
all_posterior_samples_nu_a02 = all_posterior_samples_nu_a0
all_posterior_samples_w_02 = all_posterior_samples_w_0
all_posterior_samples_nu_w02 = all_posterior_samples_nu_w0
all_posterior_samples_alpha2 = all_posterior_samples_alpha
all_posterior_samples_beta2 = all_posterior_samples_beta
...
file_name = '/vsc-hard-mounts/leuven-data/343/vsc34314/2500 trials/50subjects_2500trials2.dil'
list_of_variable_names = (
    "all_lps2", "all_true_params2", "all_true_states2","all_inf_params2", "all_inf_states2",
    "all_emissions2", "all_inputs2",
    "all_posterior_samples_a2", "all_posterior_samples_sigmasq2", "all_posterior_samples_w2", "all_posterior_samples_states2","all_posterior_samples_states_sd2",
    "all_posterior_samples_a02", "all_posterior_samples_nu_a02",
    "all_posterior_samples_alpha2", "all_posterior_samples_beta2",
    "all_posterior_samples_w_02","all_posterior_samples_nu_w02",
