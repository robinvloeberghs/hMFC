...
keys = jr.split(jr.PRNGKey(1237), num_datasets)
...
df_recovery_local.to_csv(f'{num_trials}trials_{num_subjects}subjects_recovery_localparams4.csv', index=False)
...
df_recovery_criterion_heatmap.to_csv(f'{num_trials}trials_{num_subjects}subjects_recovery_criterion_heatmap4.csv', index=False)
...
df_posterior_means.to_csv(f'{num_trials}trials_{num_subjects}subjects_posterior_means4.csv', index=False)
...
all_lps4 = all_lps
all_true_params4 = all_true_params 
all_true_states4 = all_true_states

all_posterior_samples_states4 = all_posterior_samples_states
all_posterior_samples_states_sd4 = all_posterior_samples_states_sd

all_posterior_samples_a4 = all_posterior_samples_a
all_posterior_samples_sigmasq4 = all_posterior_samples_sigmasq
all_posterior_samples_w4 = all_posterior_samples_w
all_posterior_samples_mu_x4 = all_posterior_samples_mu_x


all_posterior_samples_mu_a4 = all_posterior_samples_mu_a
all_posterior_samples_sigma_a4 = all_posterior_samples_sigma_a
all_posterior_samples_beta_sigmasq4 = all_posterior_samples_beta_sigmasq
all_posterior_samples_sigma_mu_x4 = all_posterior_samples_sigma_mu_x
all_posterior_samples_mu_sigmasq4 = all_posterior_samples_mu_sigmasq
all_posterior_samples_mu_w4 = all_posterior_samples_mu_w
all_posterior_samples_sigma_w4 = all_posterior_samples_sigma_w




file_name = '/vsc-hard-mounts/leuven-data/343/vsc34314/hMFC/50subjects_5000trials4.dil'

list_of_variable_names = (
    "all_lps4", "all_true_params4", "all_true_states4",
    "all_posterior_samples_states4","all_posterior_samples_states_sd4",
    "all_posterior_samples_a4", "all_posterior_samples_sigmasq4", "all_posterior_samples_w4", "all_posterior_samples_mu_x4",
    "all_posterior_samples_mu_a4", "all_posterior_samples_sigma_a4",
    "all_posterior_samples_mu_sigmasq4", "all_posterior_samples_beta_sigmasq4",
    "all_posterior_samples_sigma_mu_x4",
    "all_posterior_samples_mu_w4","all_posterior_samples_sigma_w4",
