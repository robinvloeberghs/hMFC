...
seed = jnp.arange(num_datasets) + 40 # to make sure we don't have the same datasets as other file
...
all_inf_params5 = all_inf_params
all_inf_states5 = all_inf_states
all_emissions5 = all_emissions
all_inputs5 = all_inputs
all_lps5 = all_lps
all_posterior_samples_a05 = all_posterior_samples_a0
all_posterior_samples_nu_a05 = all_posterior_samples_nu_a0
all_posterior_samples_w_05 = all_posterior_samples_w_0
all_posterior_samples_nu_w05 = all_posterior_samples_nu_w0
all_posterior_samples_alpha5 = all_posterior_samples_alpha
all_posterior_samples_beta5 = all_posterior_samples_beta
...
file_name = '/vsc-hard-mounts/leuven-data/343/vsc34314/5000 trials/50subjects_5000trials5.dil'
list_of_variable_names = (
    "all_lps5", "all_true_params5", "all_true_states5","all_inf_params5", "all_inf_states5",
    "all_emissions5", "all_inputs5",
    "all_posterior_samples_a5", "all_posterior_samples_sigmasq5", "all_posterior_samples_w5", "all_posterior_samples_states5","all_posterior_samples_states_sd5",
    "all_posterior_samples_a05", "all_posterior_samples_nu_a05",
    "all_posterior_samples_alpha5", "all_posterior_samples_beta5",
    "all_posterior_samples_w_05","all_posterior_samples_nu_w05",
