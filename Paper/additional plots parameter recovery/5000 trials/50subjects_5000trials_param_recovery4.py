...
seed = jnp.arange(num_datasets) + 30 # to make sure we don't have the same datasets as other file
...
all_inf_params4 = all_inf_params
all_inf_states4 = all_inf_states
all_emissions4 = all_emissions
all_inputs4 = all_inputs
all_lps4 = all_lps
all_posterior_samples_a04 = all_posterior_samples_a0
all_posterior_samples_nu_a04 = all_posterior_samples_nu_a0
all_posterior_samples_w_04 = all_posterior_samples_w_0
all_posterior_samples_nu_w04 = all_posterior_samples_nu_w0
all_posterior_samples_alpha4 = all_posterior_samples_alpha
all_posterior_samples_beta4 = all_posterior_samples_beta
...
file_name = '/vsc-hard-mounts/leuven-data/343/vsc34314/5000 trials/50subjects_5000trials4.dil'
list_of_variable_names = (
    "all_lps4", "all_true_params4", "all_true_states4","all_inf_params4", "all_inf_states4",
    "all_emissions4", "all_inputs4",
    "all_posterior_samples_a4", "all_posterior_samples_sigmasq4", "all_posterior_samples_w4", "all_posterior_samples_states4","all_posterior_samples_states_sd4",
    "all_posterior_samples_a04", "all_posterior_samples_nu_a04",
    "all_posterior_samples_alpha4", "all_posterior_samples_beta4",
    "all_posterior_samples_w_04","all_posterior_samples_nu_w04",
