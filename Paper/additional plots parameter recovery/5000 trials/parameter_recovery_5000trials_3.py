...
keys = jr.split(jr.PRNGKey(1236), num_datasets)
...
all_posterior_samples_mu_x3 = all_posterior_samples_mu_x


all_posterior_samples_mu_a3 = all_posterior_samples_mu_a
all_posterior_samples_sigma_a3 = all_posterior_samples_sigma_a
all_posterior_samples_beta_sigmasq3 = all_posterior_samples_beta_sigmasq
all_posterior_samples_sigma_mu_x3 = all_posterior_samples_sigma_mu_x
all_posterior_samples_mu_sigmasq3 = all_posterior_samples_mu_sigmasq
all_posterior_samples_mu_w3 = all_posterior_samples_mu_w
all_posterior_samples_sigma_w3 = all_posterior_samples_sigma_w




file_name = '/vsc-hard-mounts/leuven-data/343/vsc34314/hMFC/50subjects_5000trials3.dil'

list_of_variable_names = (
    "all_lps3", "all_true_params3", "all_true_states3",
    "all_posterior_samples_states3","all_posterior_samples_states_sd3",
    "all_posterior_samples_a3", "all_posterior_samples_sigmasq3", "all_posterior_samples_w3", "all_posterior_samples_mu_x3",
    "all_posterior_samples_mu_a3", "all_posterior_samples_sigma_a3",
    "all_posterior_samples_mu_sigmasq3", "all_posterior_samples_beta_sigmasq3",
    "all_posterior_samples_sigma_mu_x3",
    "all_posterior_samples_mu_w3","all_posterior_samples_sigma_w3",
